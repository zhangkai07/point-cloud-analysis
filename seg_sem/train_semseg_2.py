...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='HyperQKAN', help='model name [default: pointnet_sem_seg]')
    ...
    parser.add_argument('--log_dir', type=str, default='HyperQKAN', help='Log path [default: None]')
...
def main(args):
    ...
    TRAIN_DATASET = S3DISDataset(split='train', data_root=root, num_point=NUM_POINT, test_area=args.test_area, block_size=1.0, sample_rate=1.0, transform=t_trainsform)
