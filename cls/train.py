...
def parse_args():
    ...
    parser.add_argument('--model', default='HyperQKAN', help='model name [default: pointnet_cls]')
...
def main():
    ...
    # optimizer = torch.optim.Adam(net.parameters(), lr=args.learning_rate, momentum=0.9, weight_decay=args.weight_decay)
